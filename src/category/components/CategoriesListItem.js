...
const CategorieListItem = props => {
    ...
    {isLoading && <LoadingSpinner asOverlay/>}
      ...
      >
        <p>
        Möchtest du fortfahren und diesen Kategorie löschen?
        ...
        danach nicht mehr rückgängig gemacht werden kann.
          ...
          <TableRow
            ...
            >
              ...
              <TableCell align="center"><Button to={`../dashboard/categories/${props.id}`}><Icon className="djk-icon" icon="akar-icons:edit" height="20px" color="#fff" /></Button></TableCell>
