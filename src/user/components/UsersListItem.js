...
const UsersListItem = props => {
    ...
    const confirmDeleteHandler = async () => {
        ...
        try {
          ...
          sendRequest(process.env.REACT_APP_BACKEND_URL + `/users/${props.id}`, 'DELETE',null, {Authorization: 'Bearer ' + auth.token});
    ...
    {isLoading && <LoadingSpinner />}
      ...
      >
        <p>
        Möchtest du fortfahren und diesen Benutzer löschen?
        ...
        danach nicht mehr rückgängig gemacht werden kann.
          ...
          <TableRow
            ...
            >
              ...
              <TableCell align="center">{props.posts}</TableCell>
              <TableCell align="center"><Button to={`../dashboard/users/${props.id}`}><Icon className="djk-icon" icon="akar-icons:edit" height="20px" color="#fff" /></Button></TableCell>
