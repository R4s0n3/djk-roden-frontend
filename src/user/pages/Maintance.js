...
const Maintance = () => {
    return (
        <div className="maintance">
            ...
            <a href="https://www.instagram.com/hgs_the.next.ones_/" ><Icon className="djk-icon" icon="akar-icons:instagram-fill" height="40px" color="#006400" /></a>
            <a href="https://de-de.facebook.com/hgsthenextones/"><Icon className="djk-icon" icon="akar-icons:facebook-fill" height="40px" color="#006400" /></a>
            </div>
        </div>
    )
}
